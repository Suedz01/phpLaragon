...
@section('content')
<body style="background-image: url('image/teste3.png');background-size: cover;background-attachment: fixed"></body>
        ...
        <div class="col-md-8">
          ...
          <hr class="solid" style="border-top: 3px solid #cf3740; margin-bottom: 2rem; margin-top: 2rem">
            ...
            <div class="card" style="background-color: #3f4142; color: #ffffff;">
                <div class="card-header" style="border-color: #ffffff">{{ __('Cadastro') }}</div>
                <div class="card-body">
